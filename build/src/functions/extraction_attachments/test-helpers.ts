 ...
 */
export function createMockPayload(eventType: EventType = EventType.ExtractionAttachmentsStart) {
  return {
    connection_data: {
      org_id: 'mock-org-id',
 ...
 */
export function createMockEvent(eventType: EventType = EventType.ExtractionAttachmentsStart): AirdropEvent {
  return {
    context: {
      secrets: {
