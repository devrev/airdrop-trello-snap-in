 ...
 * @param boardId - The board ID to use in the payload
 * @returns A mock payload object
 */
export function createMockPayload(eventType: EventType = EventType.ExtractionMetadataStart, boardId: string = 'mock-board-id') {
  return {
    connection_data: {
      org_id: 'mock-org-id',
 ...
 * 
 * @param boardId - The board ID to use in the event
 * @returns A mock AirdropEvent object
 */
export function createMockEvent(boardId: string = 'mock-board-id'): AirdropEvent {
  return {
    context: {
      secrets: {
    ...
    payload: createMockPayload(EventType.ExtractionMetadataStart, boardId) as any,
  };
}