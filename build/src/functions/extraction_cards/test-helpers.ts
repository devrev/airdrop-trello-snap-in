 ...
 */
export function createMockPayload(eventType: EventType = EventType.ExtractionDataStart) {
  return {
    connection_data: {
      org_id: 'mock-org-id',
    ...
    event_context: {
      ...
      external_sync_unit_id: 'mock-board-id',
 ...
 */
export function createMockEvent(eventType: EventType = EventType.ExtractionDataStart): AirdropEvent {
  return {
    context: {
      secrets: {
