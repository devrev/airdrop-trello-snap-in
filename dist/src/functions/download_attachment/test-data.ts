...
// Mock attachment download data
export const mockAttachmentData = {
  file_data: 'base64-encoded-file-content',
  file_name: 'test-file.pdf',
  content_type: 'application/pdf',
};

export const successfulDownloadResponse: TrelloApiResponse<typeof mockAttachmentData> = {
...
export const notFoundResponse: TrelloApiResponse = {
  status_code: 404,
  api_delay: 0,
  message: 'Card, attachment, or file not found',
};
...
export const createInvalidEventTestCases = () => [
  ...
  { 
    name: 'missing idAttachment in global_values',
    eventModifier: (event: FunctionInput) => ({ 
      ...event, 
      input_data: { 
        ...event.input_data, 
    ...
    expectedMessage: 'Invalid event: missing idAttachment in global_values'
  },
  { 
    name: 'missing fileName in global_values',
    eventModifier: (event: FunctionInput) => ({ 
      ...event, 
      input_data: { 
        ...event.input_data, 
    ...
    expectedMessage: 'Invalid event: missing fileName in global_values'
  },
];